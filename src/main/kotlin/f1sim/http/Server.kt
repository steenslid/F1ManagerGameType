...
import f1sim.http.routes.BoardRoutes
...
import f1sim.http.routes.SponsorMarketRoutes
...
import f1sim.http.routes.UpgradeRoutes
...
class Server(
    ...
    fun start() {
        ...
        BoardRoutes(boardService).register(app)
        UpgradeRoutes(upgradeService).register(app)
